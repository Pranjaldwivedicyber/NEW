...
const itemSchema = new mongoose.Schema(
  {
    product: { type: mongoose.Schema.Types.ObjectId, ref: "products" }, // optional
    name: String,
    price: Number,
    size: String,
    quantity: Number,
...
const orderSchema = new mongoose.Schema(
  {
    ...
    user: { type: mongoose.Schema.Types.ObjectId, ref: "users" }, // controller expects req.user.id here
